...
class GraphController extends Controller
{
            ...
            if ($page_id && Auth::user()->token) {
               ...
               // $id = decrypt($request->id);
                ...
                if (empty(Auth::user()->token)) {
                    $msg='please generate  facebook token. > Go to <a href="'.url("/admin/account").'">Admin Account</a>.';
                }else{
                    $msg='please add facebook page id > Go to <a href="'.url("/admin/account").'">Admin Account</a>.';
                }
                $status_code= 400;
            }
    ...
    public function publishToPageOld(Request $request){
